...
| Fraunces | SIL Open Font License | 1.1 | Copyright 2018 The Fraunces Project Authors | https://github.com/google/fonts/blob/main/ofl/fraunces/OFL.txt | `OFL-Fraunces.txt` | 6 |
| Hanken Grotesk | SIL Open Font License | 1.1 | Copyright 2021 The Hanken Grotesk Project Authors | https://github.com/google/fonts/blob/main/ofl/hankengrotesk/OFL.txt | `OFL-Hanken-Grotesk.txt` | 6 |
| JetBrains Mono | SIL Open Font License | 1.1 | Copyright 2020 The JetBrains Mono Project Authors | https://github.com/google/fonts/blob/main/ofl/jetbrainsmono/OFL.txt | `OFL-JetBrains-Mono.txt` | 2 |
| Mr Dafoe | SIL Open Font License | 1.1 | Copyright (c) 2011 Alejandro Paul (Sudtipos), Reserved Font Name „Mr Dafoe“ | https://github.com/google/fonts/blob/main/ofl/mrdafoe/OFL.txt | `OFL-Mr-Dafoe.txt` | 1 |

## Was das belegt und was nicht

Belegt ist: jede Familie in diesem Ordner steht bei ihrem Hersteller unter der
SIL Open Font License 1.1. Kommerzielle Nutzung, Einbettung und Weitergabe sind
erlaubt, solange Copyright-Hinweis und Lizenz jeder Kopie beiliegen. Genau dafür
liegen die OFL-Dateien hier.

Nicht belegt ist: ob diese konkreten Dateien Byte für Byte aus der genannten
Quelle stammen. Sie tragen die passenden Familien- und Copyright-Angaben in der
Namenstabelle, ein Abgleich der Bytes gegen den Hersteller hat nicht
stattgefunden. Dies ist keine Rechtsberatung.
